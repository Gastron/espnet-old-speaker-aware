...
train_set=train_trim_xvec_1norm
dev_set=dev_trim_xvec_1norm
recog_set="dev_xvec_1norm test_xvec_1norm"
...
if [ ${stage} -le 0 ]; then
    ...
    utils/copy_data_dir.sh data/dev data/dev_xvec_1norm
    utils/copy_data_dir.sh data/test data/test_xvec_1norm
    cp data/train_trim/cmvn.ark data/train_trim_xvec_1norm/

    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-train-trim/xvectors data/train_trim_xvec_1norm/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-dev/xvectors data/dev_trim_xvec_1norm/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-dev/xvectors data/dev_xvec_1norm/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-test/xvectors data/test_xvec_1norm/
fi
...
if [ -z ${tag} ]; then
    expdir=exp/${train_set}_${backend}_${etype}_e${elayers}_subsample${subsample}_unit${eunits}_proj${eprojs}_d${dlayers}_unit${dunits}_${atype}_adim${adim}_aconvc${aconv_chans}_aconvf${aconv_filts}_mtlalpha${mtlalpha}_${opt}_sampprob${samp_prob}_bs${batchsize}_mli${maxlen_in}_mlo${maxlen_out}_xvec_1norms
    if ${do_delta}; then
