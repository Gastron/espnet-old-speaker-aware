...
embmodel="tuomas-embedding-models/AM_model.25"
...
train_set=train_trim_emb_tuomas_25
dev_set=dev_trim_emb_tuomas_25
recog_set="dev_emb_tuomas_25 test_emb_tuomas_25"
...
if [ ${stage} -le 0 ]; then
    ...
    utils/copy_data_dir.sh data/dev data/dev_emb_tuomas_25
    utils/copy_data_dir.sh data/test data/test_emb_tuomas_25
    cp data/train_trim/cmvn.ark data/train_trim_emb_tuomas_25/
fi
