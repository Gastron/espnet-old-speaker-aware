...
train_set=train_trim_xvec_norm512
dev_set=dev_trim_xvec_norm512
recog_set="dev_xvec_norm512 test_xvec_norm512"
...
if [ ${stage} -le 0 ]; then
    ...
    utils/copy_data_dir.sh data/dev data/dev_xvec_norm512
    utils/copy_data_dir.sh data/test data/test_xvec_norm512
    cp data/train_trim/cmvn.ark data/train_trim_xvec_norm512/

    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-train-trim/xvectors data/train_trim_xvec_norm512/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-dev/xvectors data/dev_trim_xvec_norm512/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-dev/xvectors data/dev_xvec_norm512/
    ln -sf /scratch/work/rouhea1/kaldi-vanilla/egs/voxceleb/v2/data/tedlium-test/xvectors data/test_xvec_norm512/
fi
...
if [ -z ${tag} ]; then
    expdir=exp/${train_set}_${backend}_${etype}_e${elayers}_subsample${subsample}_unit${eunits}_proj${eprojs}_d${dlayers}_unit${dunits}_${atype}_adim${adim}_aconvc${aconv_chans}_aconvf${aconv_filts}_mtlalpha${mtlalpha}_${opt}_sampprob${samp_prob}_bs${batchsize}_mli${maxlen_in}_mlo${maxlen_out}_xvec_norm512s
    if ${do_delta}; then
