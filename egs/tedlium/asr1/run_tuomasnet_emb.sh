...
embmodel="SS_200_2048.1.200.2000"
...
train_set=train_trim_emb_tuomasnet
dev_set=dev_trim_emb_tuomasnet
recog_set="dev_emb_tuomasnet test_emb_tuomasnet"
...
if [ ${stage} -le 0 ]; then
    ...
    utils/copy_data_dir.sh data/dev data/dev_emb_tuomasnet
    utils/copy_data_dir.sh data/test data/test_emb_tuomasnet
    cp data/train_trim/cmvn.ark data/train_trim_emb_tuomasnet/
fi
