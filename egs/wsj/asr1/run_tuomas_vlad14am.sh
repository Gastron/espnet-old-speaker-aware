...
emb_model="SS_clean_VLAD_14.700.5994.3.7.AM.25.0.15"


train_set=train_si284_tuomas_vlad14am
dev_set=test_dev93_tuomas_vlad14am
recog_set="test_dev93_tuomas_vlad14am test_eval92_tuomas_vlad14am"
...
if [ ${stage} -le 1 ]; then
    ...
    utils/copy_data_dir.sh data/test_eval93 data/test_eval92_tuomas_vlad14am
