...
emb_model="tuomas-embedding-models/AM_model.15"


train_set=train_si284_tuomas_15
dev_set=test_dev93_tuomas_15
recog_set="test_dev93_tuomas_15 test_eval92_tuomas_15"
...
if [ ${stage} -le 1 ]; then
    ...
    for rname in $recog_set; do
      utils/copy_data_dir.sh data/${rname} data/${rname}
    done
