...
train_set=train_si284_xvec_norm512_meansubstract
dev_set=test_dev93_xvec_norm512_meansubstract
test_set=test_eval92_xvec_norm512_meansubstract
recog_set="test_dev93_xvec_norm512_meansubstract test_eval92_xvec_norm512_meansubstract"
...
if [ ${stage} -le 4 ]; then
    local/dump_with_xvec_no_lda_mean_subtract.sh --cmd "$train_cmd" --nj 32 --do_delta $do_delta \
    ...
    local/dump_with_xvec_no_lda_mean_subtract.sh --cmd "$train_cmd" --nj 4 --do_delta $do_delta \
