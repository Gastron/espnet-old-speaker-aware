...
train_set=train_si284_xvec_fixed_1f
dev_set=test_dev93_xvec_fixed_1f
test_set=test_eval92_xvec_fixed_1f
recog_set="test_dev93_xvec_fixed_1f test_eval92_xvec_fixed_1f"
...
if [ ${stage} -le 2 ]; then
  ln -sf $(pwd)/exp/xvec_1f/xvectors_train_si284_xvec_local/ data/${train_set}/xvectors
  ln -sf $(pwd)/exp/xvec_1f/xvectors_test_dev93_xvec_local/ data/${dev_set}/xvectors
  ln -sf $(pwd)/exp/xvec_1f/xvectors_test_eval92_xvec_local/ data/${test_set}/xvectors
fi

if [ ${stage} -le 4 ]; then
    local/dump_with_xvec_no_lda.sh --cmd "$train_cmd" --nj 32 --do_delta $do_delta \
        data/${train_set}/feats.scp data/${train_set}/cmvn.ark data/${train_set}/xvectors exp/dump_feats/${train_set} ${feat_tr_dir}
    #This is included in recog sets
    #local/dump_with_xvec_no_lda.sh --cmd "$train_cmd" --nj 4 --do_delta $do_delta \
