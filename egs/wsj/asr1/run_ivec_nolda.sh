...
train_set=train_si284_ivec_norm512
dev_set=test_dev93_ivec_norm512
test_set=test_eval92_ivec_norm512
recog_set="test_dev93_ivec_norm512 test_eval92_ivec_norm512"
...
if [ ${stage} -le 2 ]; then
    ln -sf ${ivec_base}/wsj-train-si284/ivectors data/${train_set}/ivectors
    ln -sf ${ivec_base}/wsj-test-dev93/ivectors data/${dev_set}/ivectors
    ln -sf ${ivec_base}/wsj-test-eval92/ivectors data/${test_set}/ivectors
fi
