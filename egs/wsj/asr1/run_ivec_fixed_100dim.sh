...
train_set=train_si284_ivec_fixed_100dim
dev_set=test_dev93_ivec_fixed_100dim
test_set=test_eval92_ivec_fixed_100dim
recog_set="test_dev93_ivec_fixed_100dim test_eval92_ivec_fixed_100dim"
...
if [ ${stage} -le 2 ]; then
  ln -sf $(pwd)/exp/ivec_ngauss512/extractor_dim100/ivectors_train_si284_ivec_local/ data/${train_set}/ivectors
    ln -sf $(pwd)/exp/ivec_ngauss512/extractor_dim100/ivectors_test_dev93_ivec_local/ data/${dev_set}/ivectors
    ln -sf $(pwd)/exp/ivec_ngauss512/extractor_dim100/ivectors_test_eval92_ivec_local/ data/${test_set}/ivectors
fi

if [ ${stage} -le 4 ]; then
    local/dump_with_ivec_no_lda.sh --cmd "$train_cmd" --nj 32 --do_delta $do_delta \
    ...
    local/dump_with_ivec_no_lda.sh --cmd "$train_cmd" --nj 4 --do_delta $do_delta \
